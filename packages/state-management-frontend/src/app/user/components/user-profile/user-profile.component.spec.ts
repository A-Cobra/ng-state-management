...
describe('UserProfileComponent', () => {
  ...
  it('should show loader while submitting form', () => {
    ...
    const loader = fixture.debugElement.query(
      By.css('state-management-app-loader')
    );
  ...
  it('should display the last name input', () => {
    const lastNameInput = fixture.debugElement.query(By.css('#lastNameInput'));
  ...
  it('should display the phone number required error', () => {
    ...
    expect(phoneNumberInputRequiredError.nativeElement.textContent.trim()).toBe(
      'This field is required.'
    );
