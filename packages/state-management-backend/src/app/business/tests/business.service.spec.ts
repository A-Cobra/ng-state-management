...
import { BusinessClassificationStub, businessesStub, businessModificationDtoStub, businessStub, completeBusinessCreationDTO, initialBusinessCreationDtoStub, paginatedBusinessessData } from "./business.stubs";
...
describe('BusinessService', () => {
        ...
        const moduleRef = await Test.createTestingModule({
            providers: [
              BusinessService,
              {
                ...
                findAndCount: jest.fn().mockReturnValue( [businessesStub, businessesStub.length]),
    ...
    describe('Submit business', () => {
        it('should save partial business', async () => {
                ...
                expect(await businessService.initialCreation(initialBusinessCreationDtoStub)).toEqual(result);
        });
    });
    ...
    describe('Complete business creation', () => {
        it('Should modify businessess', async () => {
            ...
            expect(await businessService.completeBusinessCreation('a', completeBusinessCreationDTO)).toEqual(result);
        });
    });
    ...
    describe('Get businessess', () => {
        it('Should return businessess', async () => {
            ...
            expect(await businessService.search(businessSearch)).toEqual(paginatedBusinessessData);
        });
    });
});